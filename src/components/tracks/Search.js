...
class Search extends Component{
    ...
    findTrack = (dispatch, e) =>{
        ...
        axios.get(`https://api.musixmatch.com/ws/1.1/track.search?q_track=${this.state.trackTitle}&page_size=10&page=1&s_track_rating=desc1&apikey=${process.env.REACT_APP_MM_KEY}`)
         .then( res => {
